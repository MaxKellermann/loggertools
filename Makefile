...
loggerconv_SOURCES = $(addprefix src/,conv.cc earth.cc tp.cc tp-seeyou-reader.cc tp-seeyou-writer.cc cenfis.cc cenfisdb.cc tp-filser-reader.cc tp-filser-writer.cc tp-zander-reader.cc tp-zander-writer.cc)
